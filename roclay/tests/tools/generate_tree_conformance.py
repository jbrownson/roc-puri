...
def generate_source(
    ...
    lines = [
        'app [main!] { test_host: platform "./platform/main.roc", geometry: "../../geometry/main.roc", roclay: "../main.roc", conformance: "./main.roc" }',
        "",
        "# Generated by tests/tools/generate_tree_conformance.py; do not edit.",
        f"# seed={seed} cases={len(cases)}",
        "import geometry.Geometry2d",
        "import roclay.Roclay",
        "import conformance.RoclayTreeConformance",
